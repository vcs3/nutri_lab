...
def dados_paciente(request, id):
    ...
    if request.method == "GET":
        ...
        try:
            ...
            dados_paciente = DadosPaciente.objects.filter(paciente=paciente.paciente)
            return render(request,'dados_paciente.html',{'paciente': paciente.paciente,'dados_paciente':dados_paciente})
        except:
            messages.add_message(request, constants.ERROR, 'Erro interno do sistema')
            return redirect('/dados_paciente/') 
